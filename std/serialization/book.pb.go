...
type BookProto struct {
	...
	Chapters []string `protobuf:"bytes,4,rep,name=chapters,proto3" json:"chapters,omitempty"`
}
...
func (x *BookProto) GetPages() int64 {
	if x != nil {
		return x.Pages
	}
	return 0
...
func (x *BookProto) GetChapters() []string {
	if x != nil {
		return x.Chapters
	}
	return nil
...
var file_book_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x73, 0x65,
	0x72, 0x69, 0x61, 0x6c, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x6b, 0x0a, 0x09, 0x42,
	0x6f, 0x6f, 0x6b, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c,
	...
	0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x70, 0x61, 0x67, 0x65, 0x73, 0x12, 0x1a, 0x0a, 0x08,
	0x63, 0x68, 0x61, 0x70, 0x74, 0x65, 0x72, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x08,
	0x63, 0x68, 0x61, 0x70, 0x74, 0x65, 0x72, 0x73, 0x42, 0x11, 0x5a, 0x0f, 0x2e, 0x2f, 0x73, 0x65,
...
var file_book_proto_goTypes = []interface{}{
	(*BookProto)(nil), // 0: serialization.BookProto
}
